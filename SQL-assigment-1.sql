...
/* 6 ve 7 soruda yapılan sonuca göre Öncelik sırası değişmiştir. İlk sonuçta brand_id önce artan sırada sıralanmış, ardından list_price brand_id sütununa göre azalan sırada listelenmiştir. İkincisinde list_price sütunu azalan sırada listelenir ve ardından brand_id buna göre artan sırada sıralanır. */
